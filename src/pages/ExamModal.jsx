        ...
        <form onSubmit={submit}>
          <div className="books-modal-body">
            ...
            <div className="books-form-group">
              ...
              {/* Percentage scale input т-- shown when PERCENTAGE selected */}
              {form.displayMode === 'PERCENTAGE' && (
                <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <span style={{ fontSize: '0.85rem', color: '#6b7280' }}>
                    e.g. 50 т-- shows as 40% out of 50
                  </span>
                </div>
              )}

              {/* Fraction scale input т-- shown when FRACTION selected */}
              {form.displayMode === 'FRACTION' && (
                <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  />
                  <span style={{ fontSize: '0.85rem', color: '#6b7280' }}>
                    e.g. scale = 5 т-- 20 marks become /5
                  </span>
                </div>
              )}
            </div>
            ...
            <div style={{
              ...
              <span>
                ...
                {form.displayMode === 'PERCENTAGE'
                  ? ` Marks shown as % out of ${form.percentageScale || 100} (e.g. 15/20 т-- ${((15/20)*(Number(form.percentageScale)||100)).toFixed(0)}%).`
                  : ` Marks shown as fractions out of ${form.fractionScale || 10} (e.g. 15/20 т-- ${((15/20)*(Number(form.fractionScale)||10)).toFixed(2)}/${form.fractionScale || 10}).`}
              </span>
            </div>
