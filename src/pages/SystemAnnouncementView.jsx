...
const SystemAnnouncementView = () => {
  ...
  // â--â-- fetch announcement â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  useEffect(() => {
    const load = async () => {
      setLoading(true);
      try {
    ...
    <div className="page-container">
      ...
      {!loading && !error && announcement && (
        <div className="card" style={{ maxWidth: '820px', padding: '2rem 2.25rem' }}>
          ...
          {/* â--â-- Title row â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â-- */}
          <div
            style={{
              display: 'flex',
          ...
          {/* â--â-- Meta: Created By â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â-- */}
          <div
            style={{
              display: 'flex',
              flexWrap: 'wrap',
          ...
          {/* â--â-- Content: description or file attachment â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â-- */}
              ...
              {isImageUrl(announcement.fileUrl) ? (
                ...
                >
                  {downloading
                    ...
                    : <Download size={18} />}
                  <span>{downloading ? 'Downloadingâ-¦' : 'Download Attachment'}</span>
                </button>
              )}
            </div>
          )}

          {/* â--â-- Edit button (role-gated) â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â-- */}
          {canEdit() && (
