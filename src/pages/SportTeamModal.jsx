...
export default function SportTeamModal({ isOpen, mode, team, onSave, onClose, loading, dupError, onDupOk }) {
  ...
  const validate = () => {
    ...
    // т--т-- Defects 3, 4, 5: Team ID validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    ...
    // т--т-- Defects 7, 8: Coach Name validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    // Must contain only letters and spaces т-- no numbers or special characters
      ...
      <div className="books-modal" style={{ maxWidth: 520 }}>
        ...
        <form onSubmit={submit}>
          <div className="books-modal-body">
            ...
            {/* Defect 6: Duplicate Team ID popup т-- visible inside modal */}
            {dupError && (
              <div style={{
