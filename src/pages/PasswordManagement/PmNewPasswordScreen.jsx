 ...
 *
 * Normal Login flow â-- final step.
...
const PmNewPasswordScreen = ({ flow, steps, currentStep, onSuccess, onBack }) => {
  ...
  // â--â-- Real-time match state â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  return (
    <div className="auth-card">
      ...
      <div className="auth-header">
        ...
        <p className="auth-subtitle">OTP verified â-- choose your new password</p>
      </div>
