...
export default function HostelBlockDetails({ block: blockProp, onBack }) {
  ...
  // â--â-- Load rooms â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  // â--â-- Room saved â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  // â--â-- Delete room â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  // â--â-- Remove student from room â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  // â--â-- Add students to selected room â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
  ...
  return (
    <div className="page-container">
      ...
      {/* â--â-- Room Detail Panel (shown when a row is clicked) â--â-- */}
      {selRoom && (
        <div style={{
        ...
        >
          ...
          {rooms.map((r) => (
            <option key={r.roomId} value={r.roomId}
              ...
              {r.students?.length >= r.capacity ? ' â-- Full' : ''}
            </option>
          ))}
        </select>
      </div>
      ...
      <p style={{ fontSize: 12, color: 'var(--text-secondary)', marginBottom: 10 }}>
        Type a PRN â-- name appears below. Press <strong>,</strong> (comma) to add to the list.
      </p>
