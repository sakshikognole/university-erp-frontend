...
export default function SportModal({ isOpen, mode, sport, onSave, onClose, loading, dupError, onDupOk }) {
  ...
  const validate = () => {
    ...
    // т--т-- Sport ID validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    // Defects 1, 2, 3:
    ...
    // т--т-- Sport Name validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    // Defects 2, 4, 5, 7, 8:
    ...
    // т--т-- Capacity validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    if (form.capacity === '') {
      e.capacity = 'Required';
    ...
    // т--т-- Status validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
    if (!form.status) e.status = 'Required';

    // т--т-- Venue ID validation т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--т--
      ...
      <div className="books-modal" style={{ maxWidth: 480 }}>
        ...
        <form onSubmit={submit}>
          <div className="books-modal-body">
            ...
            {/* Duplicate ID popup т-- shown inside modal with OK button */}
            {dupError && (
              <div style={{
                ...
                <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                  <span style={{ fontSize: '1.3rem' }}>т-ая╕-</span>
