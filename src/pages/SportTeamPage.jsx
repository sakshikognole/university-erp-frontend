...
// â--â-- Inline Add Roster Modal â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--â--
          ...
          <div className="club-form-row">
            <div className="books-form-group">
              ...
              <p style={{ fontSize: '0.75rem', color: '#6b7280', marginTop: 4 }}>
                Type PRN â-- name auto-fills â-- press <strong>,</strong> to add
              </p>
            </div>
            <div className="books-form-group">
...
export default function SportTeamPage() {
  ...
  // ?team=T001 â-- shows TeamDetails; no param â-- shows list
  ...
  const handleDelete = async (team) => {
    if (!window.confirm(`Delete team "${team.teamId} â-- ${team.sportName}"?`)) return;
  ...
  // â--â-- Detail view â-- survives refresh because teamId is in the URL â--â--
  if (viewTeamId) {
    return (
      <TeamDetails
        teamId={viewTeamId}
  ...
  return (
    <div className="page-container">
      ...
      {loading ? (
        /* Skeleton loader â-- same layout as table */
